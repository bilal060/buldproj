...
/* harmony export */   "p": () => (/* binding */ PLASMIC)
/* harmony export */ });
/* harmony import */ var _plasmicapp_loader_nextjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(490);
...
const PricingCodeComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(null, {
    loadableGenerated: {
        modules: [
            "../plasmic-init.ts -> " + "./code-components/Pricing"
        ]
    },
    ssr: false
});
const DataCenterPricingCodeComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(null, {
    loadableGenerated: {
        modules: [
            "../plasmic-init.ts -> " + "./code-components/DataCenterPricing"
        ]
    },
    ssr: false
});
const CalculatorCodeComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(null, {
    loadableGenerated: {
        modules: [
            "../plasmic-init.ts -> " + "./code-components/Calculator"
        ]
    },
    ssr: false
});
const CalculatorComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(null, {
    loadableGenerated: {
        modules: [
            "../plasmic-init.ts -> " + "./code-components/CalculatorNew"
        ]
    },
    ssr: false
});
const YoutubeThumbnail = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(null, {
    loadableGenerated: {
        modules: [
            "../plasmic-init.ts -> " + "./code-components/Youtube"
        ]
    },
    ssr: false
});
const ReactYoutube = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(null, {
    loadableGenerated: {
        modules: [
            "../plasmic-init.ts -> " + "./code-components/Youtube"
        ]
...
const Carousel = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(null, {
    loadableGenerated: {
        modules: [
            "../plasmic-init.ts -> " + "./code-components/carousel"
        ]
    },
    ssr: false
});
    ...
    projects: [
        {
            ...
            token: "Tz0K2f5BuMYboZr7YN36pvRKPyQHqMR72hthNolKb2OkW3RONwSWYSRcrQA0HPtWgQZGflhaAphT3o0kEg"
        }
    ],
    preview: false
});
